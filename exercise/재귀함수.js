// 다이나믹 프로그래밍, 메모라이징 기법 등을 사용하는 순간이 오게 되면 중요도 올라감

// 재귀함수 : 내가 나를 호출하는 것
// 반복문으로 반복할 수 있는 것은 재귀함수로 만들 수 있다
// 재귀함수로 만들 수 있는 것은 반복문으로도 만들 수 있다

// 실무에서는 반복문 사용하시고 재귀함수는 쓰지 않기를 권장한다
// 알고리즘 문제에서는 간혹 재귀를 호출해야 할 일이 있다
// (펠린드롬: 오디오, 기러기, 스위스, 토마토, 별똥별)
// (병합정렬, 퀵정렬)
...
// 누적합
// 일일이 순회하지 않고 구할 수 있는 값이기 때문에 2개 다 비효율적인 코드
// 소수 구하는 문제 같은 곳에서 이중 for문 사용하는 것도 매우 비효율적
let result2 = 0;
...
// 펠린드롬 재귀
// https://kk3june.tistory.com/83 포스팅된 코드
